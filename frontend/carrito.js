// carrito.js FIXED
const API = "https://grandstate-customs-nai9-lq8n3u1an-alberto-cardenas-08s-projects.vercel.app/api";
...
async function checkout() {
  ...
  const res = await fetch("https://grandstate-customs-nai9-lq8n3u1an-alberto-cardenas-08s-projects.vercel.app/api/checkout", {
    method: "POST",
    headers: {
      Authorization: `Bearer ${token}`
    }
